...
def get_callbacks(config, X_train):
    ...
    param = config["params"]
    earlly_stopping_cb = tf.keras.callbacks.EarlyStopping(
        patience = param["patience"],
        restore_best_weights = param["restore_best_weights"])
    ...
    return [tensorboard_cb, earlly_stopping_cb, checkpointing_cb]
